...
const CustomCheckbox: React.FC<CustomCheckboxProps> = ({ label, checked, onChange }) => (
  <label className="flex items-center space-x-2 cursor-pointer text-sm text-gray-600 dark:text-gray-300">
    <input
      ...
      checked={checked}
      onChange={onChange}
      className="h-4 w-4 rounded border-gray-300 dark:bg-slate-900 dark:border-slate-600 text-lime-600 focus:ring-lime-500 cursor-pointer"
    />
    <span>{label}</span>
  </label>
);
...
const FieldRow: React.FC<FieldRowProps> = ({ field, onFieldChange }) => {
  return (
    <div className="flex justify-between items-center py-4 border-b border-gray-200 dark:border-slate-700 last:border-b-0">
...
export const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="p-8">
      <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100">Impostazioni</h1>
      ...
      {activeTab === 'schema' && (
        <div className="mt-8 bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm">
          <div className="flex flex-wrap justify-between items-center border-b border-gray-200 dark:border-slate-700 pb-4 mb-4 gap-4">
            <div>
              <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Personalizzazione Schema</h2>
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Attiva/disattiva campi e definisci quali sono obbligatori o critici per l'estrazione.
              </p>
            </div>
            <div className="flex items-center gap-2">
               <button onClick={handleResetSchema} className="flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-slate-600 text-sm font-medium rounded-lg text-gray-700 dark:text-gray-200 bg-white dark:bg-slate-700 hover:bg-gray-50 dark:hover:bg-slate-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 transition-colors">
      ...
      {activeTab === 'alert' && (
        <div className="mt-8 bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm">
           <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Configurazione Motore di Alert</h2>
           <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
      ...
      {activeTab === 'integrazioni' && (
        <div className="mt-8">
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 mb-6 transition-all duration-300 hover:shadow-md">
                <div className="flex items-start gap-5">
                     <GoogleDriveIcon className="w-10 h-10 mt-1 flex-shrink-0" />
                    <div className='flex-grow'>
                        <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Integrazione Google Drive</h2>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <button
                                            ...
                                            className="text-sm text-red-600 dark:text-red-400 hover:text-red-800 font-semibold px-3 py-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/30 transition-colors"
                                        >
                                            Disconnetti
                                        </button>
                                    </div>
                                    <div className="max-w-xl">
                                      <label htmlFor="drive-folder-url" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">URL Cartella Google Drive</label>
                                      <input
                                          type="text"
                                          id="drive-folder-url"
                                          ...
                                          className="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-gray-200 rounded-lg shadow-sm focus:ring-lime-500 focus:border-lime-500 text-sm"
                                      />
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 mb-6 transition-all duration-300 hover:shadow-md">
                <div className="flex items-start gap-5">
                    ...
                    <div className='flex-grow'>
                        <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Cartella Condivisa MCP</h2>
                        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400 max-w-3xl">
