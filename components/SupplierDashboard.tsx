...
export const SupplierDashboard: React.FC<SupplierDashboardProps> = ({ 
    ...
    return (
        <div className="bg-gray-50 dark:bg-slate-900 min-h-screen font-sans">
            <header className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-b border-gray-200 dark:border-slate-700 shadow-sm sticky top-0 z-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-center">
                        <div className="lg:col-span-1">
                            <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100">Dashboard Fornitore</h1>
                        ...
                        <div className="lg:col-start-2">
                            ...
                            <select
                                ...
                                className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 dark:bg-slate-700 dark:border-slate-600 dark:text-gray-200 focus:outline-none focus:ring-lime-500 focus:border-lime-500 sm:text-sm rounded-md shadow-sm"
                            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="text-center">
                            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Oppure, automatizza il processo</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {/* Google Drive Card */}
                            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 flex flex-col items-center text-center">
                                <GoogleDriveIcon className="w-12 h-12" />
                                <h4 className="mt-4 font-semibold text-gray-800 dark:text-gray-200">Google Drive</h4>
                                ...
                                <button className="mt-4 w-full px-4 py-2 border border-gray-300 dark:border-slate-600 text-sm font-medium rounded-lg text-gray-700 dark:text-gray-200 bg-white dark:bg-slate-700 hover:bg-gray-50 dark:hover:bg-slate-600">
                                    Collega (coming soon)
                                </button>
                            </div>
                            ...
                            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 flex flex-col items-center text-center">
                                ...
                                <h4 className="mt-4 font-semibold text-gray-800 dark:text-gray-200">OneDrive</h4>
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        ...
                        {/* History Card */}
                        <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700">
                            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">Cronologia Guadagni</h3>
                            <ul className="space-y-4 max-h-96 overflow-y-auto pr-2 -mr-4">
                                {sortedEarnings.length > 0 ? sortedEarnings.map(earning => (
                                    <li key={earning.id} className="flex items-center gap-4">
                                        <div className="p-2.5 bg-gray-100 dark:bg-slate-700 rounded-full">
                                        ...
                                        <div className="flex-grow">
                                            <p className="text-sm font-medium text-gray-800 dark:text-gray-200 truncate">{earning.documentName}</p>
