  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 p-8">
      <div className="max-w-7xl mx-auto">
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {results.results.slice(0, 20).map((row: any, i: number) => (
                          <tr key={i} className="border-b dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/30">
                            {Object.keys(row)
                              .filter(k => !k.startsWith('_'))
                              .slice(0, 6)
                              .map(key => (
        ...
        <div className="mt-8 bg-white dark:bg-slate-800 rounded-xl shadow-xl p-6">
