...
const ChatMessage: React.FC<{ role: 'user' | 'model'; text: string; sources?: any[]; offer?: CommercialOffer }> = ({ role, text, sources, offer }) => {
    ...
    const bubbleClasses = isUser
        ...
        : 'bg-gray-900 text-gray-200 border border-gray-800 dark:bg-slate-800 dark:text-gray-200 dark:border-slate-700';
...
`;
    ...
    return (
        <div className="flex flex-col h-full bg-black dark:bg-slate-900">
            <header className="p-4 sm:p-6 lg:p-8 border-b border-gray-800 bg-gray-900/50 dark:bg-slate-800/50 backdrop-blur-sm sticky top-0 z-10 dark:border-slate-700">
                <h1 className="text-2xl font-bold text-gray-100 dark:text-gray-100">SYD AGENT</h1>
                    ...
                    <div className="space-y-4">
                        ...
                        {isLoading && (
                            <div className="flex justify-start">
                                <div className="max-w-2xl px-4 py-3 rounded-xl shadow-sm bg-gray-900 dark:bg-slate-800 text-gray-200 dark:text-gray-200 border border-gray-800 dark:border-slate-700">
            ...
            <footer className="p-4 sm:p-6 lg:p-8 border-t border-gray-800 bg-gray-900/50 dark:bg-slate-800/50 backdrop-blur-sm sticky bottom-0 dark:border-slate-700">
                <div className="max-w-4xl mx-auto">
