...
const UploadBox: React.FC<UploadBoxProps> = ({
    ...
    return (
        <div className="bg-gray-900 dark:bg-slate-800 p-6 rounded-xl shadow-sm h-full flex flex-col">
            ...
            {!file ? (
                ...
                <div className="mt-4 p-6 bg-black dark:bg-slate-700/50 rounded-lg border border-gray-800 dark:border-slate-700 flex-grow flex flex-col justify-center">
                    <h3 className="text-base font-medium text-gray-400 dark:text-gray-300 mb-4">{t('uploadbox.file_ready')}</h3>
                     <div className="flex items-center justify-between p-3 bg-gray-900 dark:bg-slate-800 border border-gray-800 dark:border-slate-600 rounded-md">
                        <div className="flex items-center gap-4 min-w-0">
                           <FileIcon />
                            <div className="flex-grow min-w-0">
                                <p className="text-sm font-semibold text-gray-200 dark:text-gray-200 truncate">{file.name}</p>
             ...
             {error && (
                <div className="mt-4 p-3 bg-red-100 dark:bg-black0/20 text-red-800 dark:text-red-300 rounded-lg text-sm text-center">
                    {error}
                </div>
            )}
        </div>
